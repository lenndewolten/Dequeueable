...
namespace WebJobs.Azure.QueueStorage.Job.UnitTests.Services
{
    public class QueueMessagesHandlerTests
    {

        [Fact]
        public async Task Given_a_QueueMessagesHandler_when_HandleAsync_is_called_but_no_messages_are_retrieved_then_the_handler_is_not_called()
        {
            // Arrange
            ...
            var loggerMock = new Mock<ILogger<QueueMessagesHandler>>(MockBehavior.Strict);
            ...
            var sut = new QueueMessagesHandler(queueMessageManagerMock.Object, queueMessageHandlerMock.Object, loggerMock.Object);
        ...
        [Fact]
        public async Task Given_a_QueueMessagesHandler_when_HandleAsync_is_called_and_exceptions_occrured_then_it_is_logged_correctly()
        {
            // Arrange

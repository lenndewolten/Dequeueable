...
namespace WebJobs.Azure.QueueStorage.Job.IntegrationTests.Fixtures
{
    public class AzuriteFixture : IAsyncLifetime
    {
        public const int BlobPort = 5000;
        public const int QueuePort = 5001;
        public const int TablePort = 5002;
